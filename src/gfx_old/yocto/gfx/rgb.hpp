...
namespace yocto
{
    namespace gfx
    {
        ...
        public:
            ...
            static inline rgb make_ramp(double v,const double vmin,const double vmax) throw()
            {
                double R=1,G=1,B=1;
            ...
            static inline rgb rampf(float x) throw() { return make_ramp(x,0,1); }
