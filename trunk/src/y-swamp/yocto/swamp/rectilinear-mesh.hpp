...
namespace yocto 
{
    namespace swamp 
    {
        ...
        public:
            ...
            {
                return adb[ mesh::delta_name(iAxis) ].template as<axis_type>();
            }
            ...
            inline axis_type       &dX()       { return adb[ mesh::delta_name(0) ].template as<axis_type>(); }
            inline const axis_type &dX() const { return adb[ mesh::delta_name(0) ].template as<axis_type>(); }
            
            inline axis_type       &dY()       { return adb[ mesh::delta_name(1) ].template as<axis_type>(); }
            inline const axis_type &dY() const { return adb[ mesh::delta_name(1) ].template as<axis_type>(); }
            
            
            inline axis_type       &dZ()       { return adb[ mesh::delta_name(2) ].template as<axis_type>(); }
            inline const axis_type &dZ() const { return adb[ mesh::delta_name(2) ].template as<axis_type>(); }
