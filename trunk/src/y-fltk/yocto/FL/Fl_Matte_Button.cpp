#include "yocto/FL/Fl_Matte_Button.hpp"
...
// CTOR
Fl_Matte_Button::Fl_Matte_Button(int X,int Y,int W, int H, const char *l) : Fl_Button(X,Y,W,FL_MATTE_BUTTON_HEIGHT,l) {
}
