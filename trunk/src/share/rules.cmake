...
IF( "${CC_NAME}" MATCHES "gcc.*" )
  ...
  STRING( REGEX MATCH    "[0-9]+\\.[0-9]+\\.[0-9]+" GCC_TRIPLET "${GCC_VERSION}" )
  MESSAGE( STATUS "GCC_TRIPLET=${GCC_TRIPLET}")

  STRING( REGEX REPLACE  "([0-9]+)\\.[0-9]+\\.[0-9]+" "\\1" GCC_MAJOR "${GCC_TRIPLET}")
  STRING( REGEX REPLACE  "[0-9]+\\.([0-9]+)\\.[0-9]+" "\\1" GCC_MINOR "${GCC_TRIPLET}")
  STRING( REGEX REPLACE  "[0-9]+\\.[0-9]+\\.([0-9]+)" "\\1" GCC_PATCH "${GCC_TRIPLET}")
