...
namespace yocto 
{
	namespace math
	{
		...
		template<> const real_t numeric<real_t>::sqrteps  = Sqrt( REAL_EPSILON );
		...
		template <> const real_t numeric<real_t>::tiny = Pow( 10, numeric<real_t>::min_10_exp );
		template <> const real_t numeric<real_t>::huge = Pow( 10, numeric<real_t>::max_10_exp );
