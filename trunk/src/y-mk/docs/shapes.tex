...
The solution are
\begin{equation}
	\vec{B} = -\mymat{S}_{zz}^{-1} \mytrn{\mymat{S}}_{qz}\vec{A}
\end{equation}
and
\begin{equation}
	\left(\mymat{S}_{qq} - \mymat{S}_{qz}\mymat{S}_{zz}^{-1} \mytrn{\mymat{S}}_{qz}\right) \vec{A} = \lambda \mymat{C}\vec{A}.
\end{equation}
If we assume that $\mymat{C}$ is invertible then we define
\begin{equation}
	\mymat{M} = \mymat{C}^{-1} \left(\mymat{S}_{qq} - \mymat{S}_{qz}\mymat{S}_{zz}^{-1} \mytrn{\mymat{S}}_{qz}\right)
\end{equation}
